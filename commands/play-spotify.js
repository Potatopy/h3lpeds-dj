...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("playspotify")
        .setDescription("plays songs from spotify")
        ...
        .addSubcommand((subcommand) =>
            subcommand
                .setName("album")
                .setDescription("Loads an album from url")
        ...
        subcommand
            .setName("playlist")
            .setDescription("Loads a playlist from spotify.")
            .addStringOption((option) => option.setName("url").setDescription("playlist url").setRequired(true))
        ),
    run: async ({ client, interaction }) => {
        ...
        if (interaction.options.getSubcommand() === "song") {
            ...
            embed
                ...
                .setFooter({ text: `Duration: ${song.duration} made by zach.#0001` })
